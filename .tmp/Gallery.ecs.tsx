        ...
        <div className="grid grid-cols-2 gap-3 animate-fade-in sm:grid-cols-2 sm:gap-4 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
          {filteredItems.map((item) => {
            ...
            <div
              ...
              className="group relative flex min-w-0 cursor-pointer flex-col overflow-hidden rounded-[28px] border border-remuse-border bg-remuse-panel transition-all duration-300 hover:-translate-y-1 hover:border-remuse-accent focus:outline-none focus:ring-2 focus:ring-remuse-accent"
              style={{
            ...
            >
              ...
              <div
                className="relative aspect-[3/4] overflow-hidden p-3 sm:p-4"
                style={{
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 sm:p-5">
                  ...
                  >
                  <p className="mb-1 font-mono text-[10px] uppercase tracking-[0.32em] sm:text-[11px]" style={{ color: theme.accentSoft }}>
                    {item.material}
                  </p>

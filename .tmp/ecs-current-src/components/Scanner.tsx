...
const IdeaGenerator = lazyWithChunkRetry(() => import('./IdeaGenerator'), 'IdeaGeneratorInline');
    ...
    <div className="h-full flex flex-col items-center justify-start pt-12 md:justify-center p-4 md:p-6 relative bg-remuse-dark overflow-y-auto">
            ...
            <div className="bg-remuse-panel border border-remuse-border p-4 md:p-6 clip-corner shadow-2xl animate-fade-in max-h-[calc(100dvh-8rem)] overflow-y-auto">
                ...
                {generatedSticker ? (
                    ...
                    <button 
                        ...
                        data-testid="scanner-generate-sticker"
                    >
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <button
                        ...
                        data-testid={generatedSticker ? 'scanner-view-sticker' : 'scanner-view-idea'}
                    >
      ...
      {previewDetailItem && (
        <div className="fixed inset-0 z-[100] animate-fade-in">
          <Suspense
            fallback={(
              <div className="flex h-full items-center justify-center bg-remuse-dark/95">

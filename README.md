...
Remuse 是一个全栈数字再生博物馆项目，目标是把“旧物上传 -> AI 识别 -> 归档进展馆 -> 生成贴纸 / 拼豆图纸 / 表情包 / 改造指南 / 记忆内容”串成一条完整体验链路。

- GitHub 仓库：https://github.com/cupkk/Remuse
...
本仓库开源版本的核心代码，包括前端、后端、数据层 schema、AI 编排、构建脚本和测试脚本。
